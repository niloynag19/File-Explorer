...
export function FolderOpenIcon({ className = "", size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M5 19h14a2 2 0 0 0 2-2l1-7H8l-3 9Z" />
    </svg>
  );
}
...
export function FilePlusIcon({ className = "", size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
